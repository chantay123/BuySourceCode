        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Paradigm = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VerificationCodes_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CodeFiles_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CodeFiles_Users_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CodeFiles_Users_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodePromotions", x => new { x.CodeId, x.PromotionId });
                    table.ForeignKey(
                        name: "FK_CodePromotions_Promotions_PromotionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodePromotionCodeId = table.Column<int>(type: "integer", nullable: true),
                    CodePromotionPromotionId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Codes_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Codes_CodePromotions_CodePromotionCodeId_CodePromotionPromo~",
                        columns: x => new { x.CodePromotionCodeId, x.CodePromotionPromotionId },
                        principalTable: "CodePromotions",
                        principalColumns: new[] { "CodeId", "PromotionId" });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Codes_ProgrammingLanguages_ProgrammingLanguageId",
                        column: x => x.ProgrammingLanguageId,
                        principalTable: "ProgrammingLanguages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Codes_Users_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CodeTags", x => new { x.CodeId, x.TagId });
                    table.ForeignKey(
                        name: "FK_CodeTags_Codes_CodeId",
                        column: x => x.CodeId,
                        principalTable: "Codes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CodeTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Codes_CodeId",
                        column: x => x.CodeId,
                        principalTable: "Codes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Downloads_Codes_CodeId",
                        column: x => x.CodeId,
                        principalTable: "Codes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Codes_CodeId",
                        column: x => x.CodeId,
                        principalTable: "Codes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFavorites", x => new { x.UserId, x.CodeId });
                    table.ForeignKey(
                        name: "FK_UserFavorites_Codes_CodeId",
                        column: x => x.CodeId,
                        principalTable: "Codes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CodeFiles_CodeId",
                table: "CodeFiles",
                column: "CodeId");

            migrationBuilder.CreateIndex(
                name: "IX_CodeFiles_DeletedById",
                table: "CodeFiles",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_CodeFiles_UpdatedById",
                table: "CodeFiles",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Codes_CodePromotionCodeId_CodePromotionPromotionId",
                table: "Codes",
                columns: new[] { "CodePromotionCodeId", "CodePromotionPromotionId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Codes_ProgrammingLanguageId",
                table: "Codes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerificationCodes_DeviceId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CodePromotions_Codes_CodeId",
                table: "CodePromotions",
                column: "CodeId",
                principalTable: "Codes",
                principalColumn: "Id",
